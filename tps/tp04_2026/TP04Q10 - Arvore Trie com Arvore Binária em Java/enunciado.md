# TP04Q10 - Árvore Trie com Árvore Binária em Java
...
### Questão 10 - Árvore Trie com Árvore Binária em Java

Refaça a questão "Árvore Binária em Java" do TP03 com Árvore Trie usando Árvore Binária.

No arquivo de saída, para cada pesquisa, antes de apresentar o resultado, imprima o caractere do nó visitado da Trie.

**Nome do arquivo de log:** `matrícula_arvore_trie_arvore.txt`
